...
public class ShapeCollection {
    ...
    public ShapeCollection() {
        ...
        shapesCollection.add(new Shapes("Blinker", blinker, 2, 0));
        int[][] toad = {{1, 0}, {2, 0}, {3, 0}, {0, 1}, {1, 1}, {2, 1}};
        shapesCollection.add(new Shapes("Toad", toad, 3, 1));
        int[][] glider = {{0, 0}, {1, 0}, {2, 0}, {0, 1}, {1, 2}};
        shapesCollection.add(new Shapes("Glider", glider, 2, 2));
        int[][] spaceship = {{1, 0}, {4, 0}, {0, 1}, {0, 2},
                {4, 2}, {0, 3}, {1, 3}, {2, 3}, {3, 3}};
        shapesCollection.add(new Shapes("Spaceship", spaceship, 4, 3));
        int[][] pulsar = {
                //upper half
                {2, 0}, {3, 0}, {9, 0}, {10, 0},
                {3, 1}, {4, 1}, {8, 1}, {9, 1},
        ...
        shapesCollection.add(new Shapes("Pulsar", pulsar, 12, 12));
        // some more shapes
        int[][] bipole = {{0, 0}, {1, 0}, {0, 1}, {3, 2}, {2, 3}, {3, 3}};
        shapesCollection.add(new Shapes("Bipole", bipole, 3, 3));
