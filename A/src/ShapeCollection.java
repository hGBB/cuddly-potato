...
public class ShapeCollection {
    ...
    private LinkedList<Shapes2> shapesCollection; // TODO: anderes speichermedium mit welchem alle objecte aufgerufen werden können!

    public LinkedList<Shapes2> getShapesCollection() {
