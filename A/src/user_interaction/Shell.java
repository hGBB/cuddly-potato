...
import gameOfLife.GridImpl;
import gameOfLife.Shape;
import gameOfLife.ShapeCollection;
...
public final class Shell {
                ...
                switch (input.toLowerCase().charAt(0)) {
                    ...
                    case 'h':
                        System.out.println("Hello and welcome to Conway's"
                                ...
                                + "First you have to create a new gameOfLife.Grid using \n"
                                + "NEW x y \n"
                                ...
                                + " of cells \n"
                                + "If a living gameOfLife.Cell has 2 or 3 neighboring "
                                + "living Cells it stays alive \n"
                                + "in any other case the living gameOfLife.Cell dies. \n"
                                + "If a dead gameOfLife.Cell has exactly 3 living"
                                ...
                                + "gameOfLife.Shape s \n"
                                + "Loads a predefined gameOfLife.Shape on the gameOfLife.Grid. \n"
                                + "This is the list of all available gameOfLife.Shape: \n"
                                + "Block \n"
                                + "Boat \n"
                                + "Blinker \n"
                                + "Toad \n"
    ...
    /**
     * Help-method to check if the User's input according to the gameOfLife.Grid
    ...
    /**
     * Help-method to check if the Game of Life gameOfLife.Grid has been initialized to
     * prevent NullPointerExceptions.
     *
     * @param grid An instance of the Game of Life gameOfLife.Grid.
    ...
    private static boolean initialized(Grid grid) {
        if (grid != null) {
            ...
            error("gameOfLife.Grid hasn't been initialized yet! Try 'NEW + number "
     ...
     * @return If the gameOfLife.Grid is wide enough.
     */
    private static boolean chosenInputIsOnGrid(Grid grid, int col, int row) {
        if (grid.getColumns() > col && grid.getRows() > row
            ...
            error("The chosen gameOfLife.Cell is out of bounds! Stay on the grid "
    ...
    /**
     * This method uses a gameOfLife.Shape Collection to create predefined gameOfLife.Shape
     * centered on the gameOfLife.Grid.
     *
     * @param gol    An instance of the Game of Life grid.
     * @param token  The User input calling a certain gameOfLife.Shape.
     * @param shapes A predefined Collection of gameOfLife.Shape.
     */
