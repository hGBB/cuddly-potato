...
public final class Shell {
                ...
                switch (input.toLowerCase().charAt(0)) {
                    ...
                    case 'h':
                        System.out.println("Hello and welcome to Conway's"
                                ...
                                + "First you have to create a new model.Grid using \n"
                                + "NEW x y \n"
                                ...
                                + " of cells \n"
                                + "If a living model.Cell has 2 or 3 neighboring "
                                + "living Cells it stays alive \n"
                                + "in any other case the living model.Cell dies. \n"
                                + "If a dead model.Cell has exactly 3 living"
                                ...
                                + "model.Shape s \n"
                                + "Loads a predefined model.Shape on the model.Grid. \n"
                                + "This is the list of all available model.Shape: \n"
                                + "Block \n"
                                + "Boat \n"
                                + "Blinker \n"
                                + "Toad \n"
    ...
    /**
     * Help-method to check if the User's input according to the model.Grid
    ...
    /**
     * Help-method to check if the Game of Life model.Grid has been initialized to
     * prevent NullPointerExceptions.
     *
     * @param grid An instance of the Game of Life model.Grid.
    ...
    private static boolean initialized(Grid grid) {
        if (grid != null) {
            ...
            error("model.Grid hasn't been initialized yet! Try 'NEW + number "
     ...
     * @return If the model.Grid is wide enough.
     */
    private static boolean chosenInputIsOnGrid(Grid grid, int col, int row) {
        if (grid.getColumns() > col && grid.getRows() > row
            ...
            error("The chosen model.Cell is out of bounds! Stay on the grid "
    ...
    /**
     * This method uses a model.Shape Collection to create predefined model.Shape
     * centered on the model.Grid.
     *
     * @param gol    An instance of the Game of Life grid.
     * @param token  The User input calling a certain model.Shape.
     * @param shapes A predefined Collection of model.Shape.
     */
